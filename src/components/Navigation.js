  ...
  return (
    <nav className="main-navigation">
      <div className="nav-container">
        <div className="nav-brand" onClick={() => navigate('/clinic/patients')}>
        ...
        <div className="nav-links">
          <button
            className={`nav-link ${isActive('/clinic/patients') ? 'active' : ''}`}
          ...
          <button
            className={`nav-link ${isActive('/clinic/sessions') ? 'active' : ''}`}
            onClick={() => navigate('/clinic/sessions')}
          >
            <svg width="20" height="20" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
